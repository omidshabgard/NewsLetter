      ...
      <section className={styles.results}>
        ...
        {loading ? (
          ...
          <div className={styles.newsGrid}>
           ...
           <NewsCard
           key={index}
           date={news.dateTime} // Using formatted date
           title={news.title} // News title
           description={news.body.length > 150 ? `${news.body.slice(0, 150)}...` : news.body} // Truncate body
           source={news.source} // Source title
           image={news.image} // Image URL or placeholder
         />
            ))}
          </div>
        )}
